/**********************************************************************************************************
*SpencerHiltonBank.java
*Eric Tinajero
*
*This program simulates a bank where the user can deposit or withdraw money and print the account balance.
***********************************************************************************************************/
import java.util.*;
public class SpencerHiltonBank
{
   public static void main (String[] args)
   {
      ...
      boolean toProceed = true;                                         //Used to end loop and program
      boolean depositCheck = true;                                      //Used to end loop
      boolean withdrawlCheck = true;                                    //Used to end loop
      ...
      do                                                      //Main Loop that will end the program if number 4 is entered
      {
