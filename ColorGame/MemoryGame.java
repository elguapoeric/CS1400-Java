...
*MemoryGame.java
*
*This class creates a GUI.  Its passed in an array of colors then displays an order of colors for the user
the user.  The user must then enter the color sequence in the corret order
**************************************************************************************************************/
