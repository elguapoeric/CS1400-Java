/*********************************************************************************************
*DecryptorAndEncryptor.java
*Eric Tinajero
*
*This program asks the user if they want to encrypt or decrpyt a file
**********************************************************************************************/
    ...
    do
    {
      try                                                                                            //Try catch will promote user to re renter a file if it cannot find a file.
      {
        ...
        if (doWhat.equalsIgnoreCase("encrypt"))                                                       //Loop used for encrypting a file
        {
          ...
          fileOut = new PrintWriter("C:\\Users\\Eric\\Documents\\Encrypted.txt");                     //Where encrypted file will be saved to
        ...
        if (doWhat.equalsIgnoreCase("decrypt"))                                                       //Loop used for decrypting a file.
        {
          ...
          fileOutD = new PrintWriter("C:\\Users\\Eric\\Documents\\Decrypted.txt");                    //Where decrypted file will be saved to.
          while (fileIn.hasNext()) 
          {
            sentence = fileIn.nextLine();
            count++;                                                                                  //count used to keep track of number of sentences
